	...
	<div class="mx-auto max-w-2xl text-center">
		...
		<div class="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
			...
			<a
				...
				class="inline-flex items-center gap-2 border border-white/30 px-10 py-5 text-base font-semibold uppercase tracking-[0.1em] text-white/85 transition-colors duration-200 hover:border-white/60 hover:text-white"
				style="font-family: var(--font-body);"
			>
